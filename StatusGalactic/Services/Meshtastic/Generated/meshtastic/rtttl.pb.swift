...
nonisolated struct Meshtastic_RTTTLConfig: Sendable {
...
nonisolated extension Meshtastic_RTTTLConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".RTTTLConfig"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}ringtone\0")
  ...
  static func ==(lhs: Meshtastic_RTTTLConfig, rhs: Meshtastic_RTTTLConfig) -> Bool {
