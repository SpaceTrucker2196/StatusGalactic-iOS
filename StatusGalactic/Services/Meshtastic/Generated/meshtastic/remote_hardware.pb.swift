...
nonisolated struct Meshtastic_HardwareMessage: Sendable {
  ...
  var type: Meshtastic_HardwareMessage.TypeEnum = .unset
  ...
  nonisolated enum TypeEnum: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    static let allCases: [Meshtastic_HardwareMessage.TypeEnum] = [
      .unset,
      .writeGpios,
      .watchGpios,
      .gpiosChanged,
...
nonisolated extension Meshtastic_HardwareMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".HardwareMessage"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{3}gpio_mask\0\u{3}gpio_value\0")
  ...
  static func ==(lhs: Meshtastic_HardwareMessage, rhs: Meshtastic_HardwareMessage) -> Bool {
...
nonisolated extension Meshtastic_HardwareMessage.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNSET\0\u{1}WRITE_GPIOS\0\u{1}WATCH_GPIOS\0\u{1}GPIOS_CHANGED\0\u{1}READ_GPIOS\0\u{1}READ_GPIOS_REPLY\0")
}
