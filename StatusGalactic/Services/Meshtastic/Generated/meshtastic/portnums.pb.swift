...
nonisolated enum Meshtastic_PortNum: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Meshtastic_PortNum] = [
    .unknownApp,
    .textMessageApp,
    .remoteHardwareApp,
    .positionApp,
