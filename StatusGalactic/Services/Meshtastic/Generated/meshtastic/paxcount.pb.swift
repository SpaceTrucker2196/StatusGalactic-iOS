...
///
/// TODO: REPLACE
nonisolated struct Meshtastic_Paxcount: Sendable {
...
nonisolated extension Meshtastic_Paxcount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Paxcount"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}wifi\0\u{1}ble\0\u{1}uptime\0")
  ...
  static func ==(lhs: Meshtastic_Paxcount, rhs: Meshtastic_Paxcount) -> Bool {
