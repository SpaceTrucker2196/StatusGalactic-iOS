...
///
/// TODO: REPLACE
nonisolated struct Meshtastic_StoreAndForward: Sendable {
  ...
  ///
  /// TODO: REPLACE
  var rr: Meshtastic_StoreAndForward.RequestResponse = .unset

  ///
  /// TODO: REPLACE
  var variant: Meshtastic_StoreAndForward.OneOf_Variant? = nil

  ///
  /// TODO: REPLACE
  var stats: Meshtastic_StoreAndForward.Statistics {
    get {
  ...
  ///
  /// TODO: REPLACE
  var history: Meshtastic_StoreAndForward.History {
    get {
  ...
  ///
  /// TODO: REPLACE
  var heartbeat: Meshtastic_StoreAndForward.Heartbeat {
    get {
  ...
  /// 001 - 063 = From Router
  /// 064 - 127 = From Client
  nonisolated enum RequestResponse: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    static let allCases: [Meshtastic_StoreAndForward.RequestResponse] = [
      .unset,
      .routerError,
      .routerHeartbeat,
      .routerPing,
  ...
  ///
  /// TODO: REPLACE
  nonisolated struct Statistics: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  ///
  /// TODO: REPLACE
  nonisolated struct Heartbeat: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
nonisolated extension Meshtastic_StoreAndForward: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}rr\0\u{1}stats\0\u{1}history\0\u{1}heartbeat\0\u{1}text\0")
  ...
  static func ==(lhs: Meshtastic_StoreAndForward, rhs: Meshtastic_StoreAndForward) -> Bool {
...
nonisolated extension Meshtastic_StoreAndForward.Statistics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Meshtastic_StoreAndForward.protoMessageName + ".Statistics"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}messages_total\0\u{3}messages_saved\0\u{3}messages_max\0\u{3}up_time\0\u{1}requests\0\u{3}requests_history\0\u{1}heartbeat\0\u{3}return_max\0\u{3}return_window\0")
  ...
  static func ==(lhs: Meshtastic_StoreAndForward.Statistics, rhs: Meshtastic_StoreAndForward.Statistics) -> Bool {
...
nonisolated extension Meshtastic_StoreAndForward.History: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Meshtastic_StoreAndForward.protoMessageName + ".History"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}history_messages\0\u{1}window\0\u{3}last_request\0")
  ...
  static func ==(lhs: Meshtastic_StoreAndForward.History, rhs: Meshtastic_StoreAndForward.History) -> Bool {
...
nonisolated extension Meshtastic_StoreAndForward.Heartbeat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Meshtastic_StoreAndForward.protoMessageName + ".Heartbeat"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}period\0\u{1}secondary\0")
  ...
  static func ==(lhs: Meshtastic_StoreAndForward.Heartbeat, rhs: Meshtastic_StoreAndForward.Heartbeat) -> Bool {
