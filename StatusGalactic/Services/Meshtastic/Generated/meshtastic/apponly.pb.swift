...
nonisolated struct Meshtastic_ChannelSet: Sendable {
  ...
  ///
  /// LoRa config
  var loraConfig: Meshtastic_Config.LoRaConfig {
    get {_loraConfig ?? Meshtastic_Config.LoRaConfig()}
    set {_loraConfig = newValue}
  }
  /// Returns true if `loraConfig` has been explicitly set.
  var hasLoraConfig: Bool {self._loraConfig != nil}
  ...
  fileprivate var _loraConfig: Meshtastic_Config.LoRaConfig? = nil
}
...
nonisolated extension Meshtastic_ChannelSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ChannelSet"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}settings\0\u{3}lora_config\0")
  ...
  static func ==(lhs: Meshtastic_ChannelSet, rhs: Meshtastic_ChannelSet) -> Bool {
