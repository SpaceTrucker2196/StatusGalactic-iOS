...
nonisolated enum FieldType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated enum IntSize: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated enum TypenameMangling: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated enum DescriptorSize: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
/// fields.
nonisolated struct NanoPBOptions: @unchecked Sendable {
  ...
  var hasMaxSize: Bool {_storage._maxSize != nil}
  ...
  var hasMaxLength: Bool {_storage._maxLength != nil}
  ...
  var hasMaxCount: Bool {_storage._maxCount != nil}
  ...
  var hasIntSize: Bool {_storage._intSize != nil}
  ...
  var hasLongNames: Bool {_storage._longNames != nil}
  ...
  var hasPackedStruct: Bool {_storage._packedStruct != nil}
  ...
  var hasPackedEnum: Bool {_storage._packedEnum != nil}
  ...
  var hasSkipMessage: Bool {_storage._skipMessage != nil}
  ...
  var hasNoUnions: Bool {_storage._noUnions != nil}
  ...
  var hasMsgid: Bool {_storage._msgid != nil}
  ...
  var hasAnonymousOneof: Bool {_storage._anonymousOneof != nil}
  ...
  var hasProto3: Bool {_storage._proto3 != nil}
  ...
  var hasProto3SingularMsgs: Bool {_storage._proto3SingularMsgs != nil}
  ...
  var hasEnumToString: Bool {_storage._enumToString != nil}
  ...
  var hasFixedLength: Bool {_storage._fixedLength != nil}
  ...
  var hasFixedCount: Bool {_storage._fixedCount != nil}
  ...
  var hasSubmsgCallback: Bool {_storage._submsgCallback != nil}
  ...
  var hasMangleNames: Bool {_storage._mangleNames != nil}
  ...
  var hasCallbackDatatype: Bool {_storage._callbackDatatype != nil}
  ...
  var hasCallbackFunction: Bool {_storage._callbackFunction != nil}
  ...
  var hasDescriptorsize: Bool {_storage._descriptorsize != nil}
  ...
  var hasDefaultHas: Bool {_storage._defaultHas != nil}
  ...
  var hasTypeOverride: Bool {_storage._typeOverride != nil}
  ...
  var hasSortByTag: Bool {_storage._sortByTag != nil}
  ...
  var hasFallbackType: Bool {_storage._fallbackType != nil}
...
nonisolated let Nanopb_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
nonisolated let Extensions_nanopb_fileopt = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<NanoPBOptions>, SwiftProtobuf.Google_Protobuf_FileOptions>(
  _protobuf_fieldNumber: 1010,
  fieldName: "nanopb_fileopt"
)

nonisolated let Extensions_nanopb_msgopt = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<NanoPBOptions>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
  _protobuf_fieldNumber: 1010,
  fieldName: "nanopb_msgopt"
)

nonisolated let Extensions_nanopb_enumopt = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<NanoPBOptions>, SwiftProtobuf.Google_Protobuf_EnumOptions>(
  _protobuf_fieldNumber: 1010,
  fieldName: "nanopb_enumopt"
)

nonisolated let Extensions_nanopb = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<NanoPBOptions>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
  _protobuf_fieldNumber: 1010,
  fieldName: "nanopb"
)
...
nonisolated extension FieldType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0FT_DEFAULT\0\u{1}FT_CALLBACK\0\u{1}FT_STATIC\0\u{1}FT_IGNORE\0\u{1}FT_POINTER\0\u{1}FT_INLINE\0")
}

nonisolated extension IntSize: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0IS_DEFAULT\0\u{2}\u{8}IS_8\0\u{2}\u{8}IS_16\0\u{2}\u{10}IS_32\0\u{2} IS_64\0")
}

nonisolated extension TypenameMangling: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0M_NONE\0\u{1}M_STRIP_PACKAGE\0\u{1}M_FLATTEN\0\u{1}M_PACKAGE_INITIALS\0")
}

nonisolated extension DescriptorSize: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DS_AUTO\0\u{1}DS_1\0\u{1}DS_2\0\u{2}\u{2}DS_4\0\u{2}\u{4}DS_8\0")
}
