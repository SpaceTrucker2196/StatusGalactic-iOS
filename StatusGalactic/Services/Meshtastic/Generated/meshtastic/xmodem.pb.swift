...
nonisolated struct Meshtastic_XModem: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var control: Meshtastic_XModem.Control = .nul
  ...
  nonisolated enum Control: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    static let allCases: [Meshtastic_XModem.Control] = [
      .nul,
      .soh,
      .stx,
      .eot,
...
nonisolated extension Meshtastic_XModem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".XModem"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}control\0\u{1}seq\0\u{1}crc16\0\u{1}buffer\0")
  ...
  static func ==(lhs: Meshtastic_XModem, rhs: Meshtastic_XModem) -> Bool {
...
nonisolated extension Meshtastic_XModem.Control: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NUL\0\u{1}SOH\0\u{1}STX\0\u{2}\u{2}EOT\0\u{2}\u{2}ACK\0\u{2}\u{f}NAK\0\u{2}\u{3}CAN\0\u{2}\u{2}CTRLZ\0")
}
