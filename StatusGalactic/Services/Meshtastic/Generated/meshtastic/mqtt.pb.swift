...
nonisolated struct Meshtastic_ServiceEnvelope: Sendable {
  ...
  var packet: Meshtastic_MeshPacket {
    get {_packet ?? Meshtastic_MeshPacket()}
    set {_packet = newValue}
  }
  /// Returns true if `packet` has been explicitly set.
  var hasPacket: Bool {self._packet != nil}
  ...
  fileprivate var _packet: Meshtastic_MeshPacket? = nil
}

///
/// Information about a node intended to be reported unencrypted to a map using MQTT.
nonisolated struct Meshtastic_MapReport: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var region: Meshtastic_Config.LoRaConfig.RegionCode = .unset

  ///
  /// Modem preset used by the radio (LongFast, MediumSlow, etc...)
  var modemPreset: Meshtastic_Config.LoRaConfig.ModemPreset = .longFast
  ...
  var hasOptedReportLocation_p: Bool = false
...
nonisolated extension Meshtastic_ServiceEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ServiceEnvelope"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}packet\0\u{3}channel_id\0\u{3}gateway_id\0")
  ...
  static func ==(lhs: Meshtastic_ServiceEnvelope, rhs: Meshtastic_ServiceEnvelope) -> Bool {
...
nonisolated extension Meshtastic_MapReport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Meshtastic_MapReport, rhs: Meshtastic_MapReport) -> Bool {
